...
# --- 2. GESTIÓN DE ESTILOS (RESTAURACIÓN EXACTA v50.8) ---
def inject_style(mode):
    # CSS Base (Copia exacta v50.8 + contenedor logo)
    base_css = """
    <style>
    ...
    if mode == "login":
        # TEMA LOGIN (Copia exacta v50.8 - Blanco y Negro)
        theme_css = """
        <style>
        ...
        # TEMA DASHBOARD (Oscuro - Nuevo añadido necesario)
        theme_css = """
        <style>
        ...
        # TEMA TEST (Copia exacta v50.8 - Oscuro)
        theme_css = """
        <style>
            .stApp { background-color: #0E1117 !important; color: #FAFAFA !important; }
