...
# --- 1.2 MAPA DE VARIABLES (SUPER-REGULADO) ---
VARIABLE_MAP = {
    # --- DIMENSIONES POSITIVAS (SUMAN POTENCIAL) ---
    
    # 1. ACHIEVEMENT (Logro / Ejecución)
    ...
    # 2. RISK PROPENSITY (Propensión al Riesgo / Acción)
    ...
    # 3. INNOVATIVENESS (Innovación / Estrategia)
    ...
    # 4. LOCUS OF CONTROL (Responsabilidad / Realismo)
    ...
    # 5. SELF-EFFICACY (Autoeficacia / Liderazgo / Venta)
    ...
    # 6. AUTONOMY (Autonomía / Independencia)
    ...
    # 7. AMBIGUITY TOLERANCE (Resiliencia / Calma)
    ...
    # 8. EMOTIONAL STABILITY (Integridad / Valores / Estabilidad)
    ...
    # --- FLAGS DE FRICCIÓN (RESTAN PUNTOS O GENERAN ALERTAS) ---

    # A. EXCITABLE (Volátil / Agresivo)
    ...
    # F. ARROGANT (Soberbio / Narcisista)
    ...
    # G. MISCHIEVOUS (Manipulador / Tramposo / Arriesgado Tóxico)
    ...
    # H. MELODRAMATIC (Victimista / Teatrero)
    ...
    # I. DILIGENT (Perfeccionista / Rígido)
    ...
    # J. DEPENDENT (Sumiso / Complaciente)
