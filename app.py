...
# --- 2. GESTIÓN DE ESTILOS (V23 - ESTABLE) ---
def inject_style(mode):
    ...
    if mode == "login":
        ...
        theme_css = """
            ...
            /* Botón estilo Navy sobre fondo blanco */
            .stButton > button {
        ...
        theme_css = """
            ...
            /* BOTONES SECTOR GRANDES (2 filas x 4 columnas) */
            ...
            /* Estilo para botón deshabilitado (Próximamente) */
