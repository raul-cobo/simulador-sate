...
# --- 2. GESTIÓN DE ESTILOS (COPIADO EXACTO DE TU v50.8) ---
...
# DICCIONARIO MAESTRO (SOLUCIONA EL LOCUS A 0 Y PUNTOS PERDIDOS)
KEY_TRANSLATION = {
    # Achievement
    ...
    # Locus Control (AQUÍ ESTABA EL PROBLEMA)
...
def parse_logic(logic_str):
    ...
    for part in parts:
        try:
            ...
            val = int(val_str)
            balanced_val = int(round(val / 5.0)) # AQUI ESTA LA CLAVE DEL EQUILIBRIO
...
# --- 5. INTERFAZ GRÁFICA (TU DISEÑO DE CONFIANZA) ---
