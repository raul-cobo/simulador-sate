...
# --- 2. GESTIÓN DE ESTILOS (ESTRUCTURA v50.8 ORIGINAL) ---
def inject_style(mode):
    # CSS Base (Igual que v50.8 + clase para el logo)
    base_css = """
    <style>
    ...
    if mode == "login":
        # TEMA ORYON (Blanco, Azul #0F2489, Títulos Gigantes)
        theme_css = """
        <style>
            ...
            .stButton button:hover { background-color: #0a1860; color: white; }
        </style>
        """
        ...
        # TEMA TEST (Copia exacta de v50.8 para no romper el juego)
        theme_css = """
        <style>
            .stApp { background-color: #0E1117 !important; color: #FAFAFA !important; }
            h1, h2, h3, h4, p { color: #FAFAFA !important; font-family: 'Helvetica Neue', sans-serif; }
